"""Extract only the two-view moments consumed by R10 trees.
Reuse the user's existing replay.py; do not rebuild neural tensors. A synthetic
parity test is supplied. Real GB10 throughput/quality have NOT been measured here.
"""
