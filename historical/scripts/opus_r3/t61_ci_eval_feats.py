"""R3-E19b: the t52/t58 features for the EVAL CI frame rows (r18/main/ci_eval_full.parquet), eval phase."""
import numpy as np, pandas as pd
A_ = "/home/thisray/projects/260916_Kaggle_Poker_artifacts"; OUT = f"{A_}/opus_r1_20260917"; RAW = f"{A_}/data/raw"; D = f"{OUT}/np"
import pairindex as PI
seq = pd.read_parquet(f"{OUT}/r18/main/ci_eval_full.parquet")[["slot", "h", "pair_id"]].drop_duplicates().reset_index(drop=True)
...
d.to_parquet(f"{OUT}/r3/t61_ci_eval_feats.parquet"); print("saved", d.shape)
