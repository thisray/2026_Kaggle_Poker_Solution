...
for f in ["r2j2m_lgbcat2_p2comb_other_ev_on_r15.csv", "r2n_NH3_on_r2j2m.csv", "r2n_N3_on_r2j2m.csv", "r2n_N2_on_r2j2m.csv", "r2m_M3_both_on_r2j2m.csv", "r2m_M1_clear_raise_on_r2j2m.csv", "r2h2ev_on_r2j2m.csv"]:
    ...
    nm = f.replace("r2j2m", "r2j2mB"); d.to_csv(f"{C}/{nm}", index=False)
...
json.dump(rec, open(f"{C}/r2j2mB_receipt.json", "w"), indent=1)
