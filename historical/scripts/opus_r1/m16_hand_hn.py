...
for f in range(5):
    ...
    mdl = lgb.train(params, lgb.Dataset(X[tr], y[tr], weight=w), num_boost_round=600); mdl.save_model(f"{OUT}/m16_hand_f{f}.txt")
...
D.to_parquet(f"{OUT}/m16_handscores.parquet")
